...
def log_transacao(func):
    ...
    def envelope(*args, **kwargs):
        ...
        # Registra no log.txt conforme requisitos
        with open("log.txt", "a", encoding="utf-8") as f:
            f.write(f"Data/Hora: {data_hora} | Função: {func.__name__} | "
                    f"Argumentos: {args}, {kwargs} | Retorno: {resultado}\n")
